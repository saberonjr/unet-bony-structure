...
#model = keras.models.load_model('./scoliosis.keras', compile=False)
model = keras.models.load_model('/Users/soterojrsaberon/SeriousAI/BonyStructureSegmentation/Results/Unet-Resnet34/2024-09-22_11-32-23/best_model.keras', compile=False)
